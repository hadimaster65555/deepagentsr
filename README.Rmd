...
`deepagentsr` is an R-native agent harness inspired by Deep Agents. It provides a high-level `create_deep_agent()` API with R tools, a virtual filesystem, planning tools, subagents, skills, memory, human approval, permissions, context offloading, and event traces.
